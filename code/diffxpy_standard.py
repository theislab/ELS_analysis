    ...
    for clust in adata_loop.obs['louvain'].cat.categories:
        ...
        try:
            ...
            test_tmp = de.test.wald(
                ...
                formula_loc="~ 1 + condition + sample_id",
...
for test in ['Stress', 'Ctrl']:
    ...
    for clust in adata_loop.obs['louvain'].cat.categories:
        ...
        try:
            ...
            test_tmp = de.test.wald(
                data=counts_tmp.layers['counts'],
                formula_loc="~ 1 + baseline + sample_id",
                size_factors='size_factors',
                factor_loc_totest='baseline',
    ...
    with open('../results/diffxpy_louvain_correct_standard_withsampleid_2021.pickle', 'wb') as handle:
